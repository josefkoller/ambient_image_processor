...
TGVKDeshadeMaskedWidget::TGVKDeshadeMaskedWidget(QString title, QWidget *parent) :
    ...
    ui(new Ui::TGVKDeshadeMaskedWidget)
{
    ui->setupUi(this);
    this->updateAlpha();
...
TGVKDeshadeMaskedWidget::~TGVKDeshadeMaskedWidget()
{
    delete ui;
}


void TGVKDeshadeMaskedWidget::registerModule(ImageWidget *image_widget)
{
...
void TGVKDeshadeMaskedWidget::setIterationFinishedCallback(TGVKDeshadeMaskedProcessor::IterationFinished iteration_finished_callback)
{
...
ITKImage TGVKDeshadeMaskedWidget::processImage(ITKImage image)
{
...
void TGVKDeshadeMaskedWidget::on_perform_button_clicked()
{
...
void TGVKDeshadeMaskedWidget::on_stop_button_clicked()
{
    this->stop_after_next_iteration = true;
}

void TGVKDeshadeMaskedWidget::on_save_second_output_button_clicked()
{
...
void TGVKDeshadeMaskedWidget::on_load_mask_button_clicked()
{
...
void TGVKDeshadeMaskedWidget::on_save_denoised_button_clicked()
{
...
void TGVKDeshadeMaskedWidget::on_clear_mask_button_clicked()
{
    this->mask_view->setImage(ITKImage());
}

void TGVKDeshadeMaskedWidget::on_order_spinbox_editingFinished()
{
    this->updateAlpha();
}

void TGVKDeshadeMaskedWidget::updateAlpha()
{
...
void TGVKDeshadeMaskedWidget::addAlpha(uint alpha_element)
{
...
void TGVKDeshadeMaskedWidget::on_save_div_v_button_clicked()
{
