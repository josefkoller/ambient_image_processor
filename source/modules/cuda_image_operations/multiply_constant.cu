...
__global__  void multiply_constant_kernel(Pixel* image,
...
template<typename Pixel>
Pixel* multiply_constant_kernel_launch(Pixel* image_host,
                              uint width, uint height, uint depth,
                              Pixel constant_host)
{
 ...
 //   printf("found %d cuda devices.\n", cuda_device_count);
    ...
    multiply_constant_kernel<<<grid_dimension, block_dimension>>>(
...
template float* multiply_constant_kernel_launch(float* image_host,
                              uint width, uint height, uint depth,
                              float constant_host);
template double* multiply_constant_kernel_launch(double* image_host,
                              uint width, uint height, uint depth,
