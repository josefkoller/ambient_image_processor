...
template<typename Pixel>
Pixel* add_kernel_launch(Pixel* image1_host, Pixel* image2_host,
...
template float* add_kernel_launch(float* image1, float* image2,
                  uint width, uint height, uint depth);
template double* add_kernel_launch(double* image1, double* image2,
                  uint width, uint height, uint depth);
