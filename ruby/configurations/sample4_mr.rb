...
def read_parameter
  ...
  parameter[:input_image_path]="#{root_directory}/data/input/mr_serie14_slice3/00_denoised.mha"
  parameter[:input_mask_path]="#{root_directory}/data/input/mr_serie14_slice3/01_mask.mha"

  parameter[:iteration_count]=5e3
  parameter[:lambda]=1
  parameter[:alpha0]={ :min=>2, :max=>2, :count=>1 }
  parameter[:alpha1]={ :min=>0.01, :max=>1, :count=>20 }
